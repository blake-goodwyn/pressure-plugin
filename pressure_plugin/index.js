function pressure-display-plugin(name, deps) {
    console.log("This is where plugin code for pressure-display-plugin loads in the node process.");
...
module.exports = pressure-display-plugin;
